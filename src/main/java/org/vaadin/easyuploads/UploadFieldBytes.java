...
public class UploadFieldBytes extends UploadField implements HasValue<byte[]> {

    public UploadFieldBytes() {
        this(StorageMode.FILE);
    }

    public UploadFieldBytes(StorageMode mode) {
        super(mode);
